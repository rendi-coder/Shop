...
export const auth=(email,password,isLogin)=>{
    return async dispatch=>{
        ...
        let url=`https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB5ZXV32S2aeX6Q8eEUXbg2CVFB29SpB68`

        if(!isLogin){
            url=`https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyB5ZXV32S2aeX6Q8eEUXbg2CVFB29SpB68`;
        }
        try{
